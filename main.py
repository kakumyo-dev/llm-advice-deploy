...
心拍数や心拍変動、運動量、睡眠時間、睡眠の質などを丁寧に比較し、
より分かりやすい文章で説明を行ってください。
睡眠と運動に関する分析とアドバイスには、難しい言葉は使わず、自然で寄り添うような文章で、400～600文字程度で書いてください。
具体的な改善提案と総合的な評価には、根拠やポジティブなメッセージを盛り込み、400～600文字程度の自然な日本語で書いてください。
                     \n生体情報：\n\n{prompt_data}"""}
                ]
            )
